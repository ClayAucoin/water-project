...
esButton.addEventListener("click", function () {
    ...
    document.getElementById("nextButton").setAttribute("href", "water-bottle-screen.html?lang=es");
...
enButton.addEventListener("click", function () {
    ...
    document.getElementById("nextButton").setAttribute("href", "water-bottle-screen.html");
